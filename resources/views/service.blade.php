...
@section("bodypage")
    ...
    <div class="container-fluid bg-light py-6 px-5">
        <div class="text-center mx-auto mb-5" style="max-width: 600px;">
            ...
            <h1 class="display-5 text-uppercase mb-4">Suministro <span class="text-primary">e instalación</span></h1>
        </div>
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <a  href="/servicio-sintetico">
                ...
                <a href="/servicio-residencial">
                    <div class="service-item bg-white rounded d-flex flex-column align-items-center text-center">
                        ...
                        <div class="px-4 pb-4">
                            ...
                            <a class="btn text-primary" href="/servicio-residencial">Leer más<i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="/servicio-sonnoflex">
                    <div class="service-item bg-white rounded d-flex flex-column align-items-center text-center">
