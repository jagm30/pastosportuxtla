                ...
                <div class="mb-5">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            ...
                            <p>Somos expertos en la aplicación de pintura antiderrapante para canchas deportivas
                            </p>
                            

                            <p style="text-align: justify;">La seguridad es fundamental en cualquier entorno, ya sea en áreas residenciales, comerciales o industriales. Nuestro servicio de venta de pintura antiderrapante está diseñado para ayudarte a crear espacios más seguros, reduciendo el riesgo de resbalones y caídas. Ofrecemos una amplia gama de pinturas antiderrapantes de alta calidad que no solo cumplen con los estándares de seguridad, sino que también son duraderas y resistentes.
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-5">
                    <div class="d-flex flex-column justify-content-start bg-light p-4">
                        <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FPastoSinteticoST%2F%3Flocale%3Des_LA&tabs=timeline&width=500&height=700&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="500" height="700" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                    </div>
                </div>
                <!-- Category End -->
